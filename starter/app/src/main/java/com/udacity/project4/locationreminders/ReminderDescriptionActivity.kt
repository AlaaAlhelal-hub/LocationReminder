...
class ReminderDescriptionActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mapFragment = supportFragmentManager.findFragmentById(R.id.item_map_fragment) as SupportMapFragment
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        map.addMarker(MarkerOptions().position(location).title(reminderDataItem.location!!))
